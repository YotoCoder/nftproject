...
SECRET_KEY = 'django-insecure--_8-n&j8=yik$@$xo!4i1a8po9)ut4arsi+&2$_$t=3q7@qtv&'
...
JAZZMIN_SETTINGS = {
    ...
    "site_title": "vialactea.com",

    # Title on the login screen (19 chars max) (defaults to current_admin_site.site_header if absent or None)
    "site_header": "vialactea",

    # Title on the brand (19 chars max) (defaults to current_admin_site.site_header if absent or None)
    "site_brand": "vialactea",
    ...
    "welcome_sign": "Bienvendio a vialactea",
    ...
    "topmenu_links": [
        ...
        {"name": "vialactea",  "url": "https://vialactea.com", "permissions": ["auth.view_user"]},
